...
default['kibana']['version'] = '4.0.1-linux-x64' # must match version number of kibana being installed
...
default['kibana']['file']['url'] = "https://download.elasticsearch.org/kibana/kibana/kibana-#{node['kibana']['version']}.tar.gz"
